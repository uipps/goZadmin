...
go run tian_fuhao03.go -n "3 3 3 3" -r 5
go run tian_fuhao03.go -n 3 -r 5
go run F:\develope\go\go_code_path\src\github.com\uipps\goZadmin\suanfa\tianshu\tian_fuhao03.go -n "3 3 3 3" -r 5
go run F:\develope\go\go_code_path\src\github.com\uipps\goZadmin\suanfa\tianshu\tian_fuhao03.go -n 3 -r 5
...
func tianfuhao03(arg_4Num string, arg_NumResult float64) {
    ...
    i := []int{0, 1, 1, 1}                   // 循环变量，数组i用来表示4个运算符 oper[i[j]]
